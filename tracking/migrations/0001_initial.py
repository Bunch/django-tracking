...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracking_visitor', (
            ...
            ('tid', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
        ))
        ...
        db.send_create_signal('tracking', ['PageVisit'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tracking_trackingevent')

        # Deleting model 'PageVisit'
        db.delete_table('tracking_pagevisit')
    ...
    models = {
        ...
        'tracking.pagevisit': {
            ...
            'visitor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tracking.Visitor']"})
        },
        'tracking.trackingevent': {
            'Meta': {'object_name': 'TrackingEvent'},
            'data': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
        ...
        'tracking.visitor': {
            ...
            'tid': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
