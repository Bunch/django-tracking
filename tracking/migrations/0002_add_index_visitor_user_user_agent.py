...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Visitor', fields ['user', 'user_agent']
        db.create_index('tracking_visitor', ['user_id', 'user_agent'])


    def backwards(self, orm):
        # Removing index on 'Visitor', fields ['user', 'user_agent']
        db.delete_index('tracking_visitor', ['user_id', 'user_agent'])
