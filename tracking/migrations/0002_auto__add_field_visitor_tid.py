...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Visitor.tid'
        db.add_column('tracking_visitor', 'tid', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Visitor.tid'
        db.delete_column('tracking_visitor', 'tid')
