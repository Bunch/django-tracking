...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TrackingEvent', fields ['time']
        db.create_index('tracking_trackingevent', ['time'])

        # Adding index on 'PageVisit', fields ['time']
        db.create_index('tracking_pagevisit', ['time'])


    def backwards(self, orm):
        # Removing index on 'PageVisit', fields ['time']
        db.delete_index('tracking_pagevisit', ['time'])

        # Removing index on 'TrackingEvent', fields ['time']
        db.delete_index('tracking_trackingevent', ['time'])
