...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrackingEvent.data'
        db.alter_column('visualprofile_trackingevent', 'data', self.gf('django.db.models.fields.BigIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'TrackingEvent.data'
        db.alter_column('visualprofile_trackingevent', 'data', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'tracking.trackingevent': {
            'Meta': {'object_name': 'TrackingEvent', 'db_table': "'visualprofile_trackingevent'"},
